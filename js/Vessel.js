...
function initObjModel(){
    ...
    mtlLoader.setPath('../model/Vessel/');
     // Vessel 1
    mtlLoader.load('Vessel.mtl', function (materials) {
        materials.preload(); 
        var objLoader = new OBJLoader();
        objLoader.setCrossOrigin('Anonymous'); 
        objLoader.setMaterials(materials);
        objLoader.setPath('../model/Vessel/');
        objLoader.load(
            'Vessel.obj',
            function (obj) {
                //遍歷子節點，開啟每個子節點的陰影模式。
                ...
                groupTop.scale.set(0.001, 0.001, 0.001);
    ...
    mtlLoader.load('Vessel.mtl', function (materials) {
        ...
        objLoader.load(
            ...
            function (obj) {
                ...
                groupBottom.scale.set(0.001, 0.001, 0.001);
    ...
    mtlLoader.load('Vessel.mtl', function (materials) {
        ...
        objLoader.load(
            ...
            function (obj) {
                ...
                groupLeft.scale.set(0.001, 0.001, 0.001);
    ...
    mtlLoader.load('Vessel.mtl', function (materials) {
        ...
        objLoader.load(
            ...
            function (obj) {
                ...
                groupRight.scale.set(0.001, 0.001, 0.001);
