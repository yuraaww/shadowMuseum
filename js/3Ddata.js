...
function initObjModel(){
    ...
    mtlLoader.setPath('../model/3Ddata/');
     // 3Ddata 1
    mtlLoader.load('3Ddata.mtl', function (materials) {
        materials.preload();
        var objLoader = new OBJLoader();
        objLoader.setCrossOrigin('Anonymous');
        objLoader.setMaterials(materials);
        objLoader.setPath('../model/3Ddata/');
        objLoader.load(
            '3Ddata.obj',
            function (obj) {
                //遍歷子節點，開啟每個子節點的陰影模式。
                ...
                groupTop.scale.set(150, 150, 150);
    ...
    mtlLoader.load('3Ddata.mtl', function (materials) {
        ...
        objLoader.load(
            ...
            function (obj) {
                ...
                groupBottom.scale.set(150, 150, 150);
    ...
    mtlLoader.load('3Ddata.mtl', function (materials) {
        ...
        objLoader.load(
            ...
            function (obj) {
                ...
                groupLeft.scale.set(150, 150, 150);
    ...
    mtlLoader.load('3Ddata.mtl', function (materials) {
        ...
        objLoader.load(
            ...
            function (obj) {
                ...
                groupRight.scale.set(150, 150, 150);
